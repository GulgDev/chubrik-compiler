...
const commands = [
    ...
    new Command("jz", [Args.NUM], 0xE0),
    new Command("jc", [Args.NUM], 0xE1),
    new Command("js", [Args.NUM], 0xE2),
    new Command("jo", [Args.NUM], 0xE3),
    new Command("jnz", [Args.NUM], 0xE4),
    new Command("jnc", [Args.NUM], 0xE5),
    new Command("jns", [Args.NUM], 0xE6),
    new Command("jno", [Args.NUM], 0xE7),
    new Command("jmp", [Args.NUM], 0xE8),
    new Command("jmp", [Args.NUM], 0xE9),
    new Command("jmp", [Args.NUM], 0xEA),
    new Command("jmp", [Args.NUM], 0xEB),
